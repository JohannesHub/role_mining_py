import random
import pulp as pl
from import_csv import lade_bool_matrizen_gruppiert_nach_masterid
...
# --- Daten generieren ---
Alist = lade_bool_matrizen_gruppiert_nach_masterid("datenfull.csv")
for i, A in enumerate(Alist):
    print(f"Eingelesene Matrix {i}:")
    for row in A:
        print(row)
    n_users = len(A)
    n_perms = len(A[0])
